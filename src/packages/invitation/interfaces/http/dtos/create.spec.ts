        ...
        describe('hosts', () => {
            ...
            describe('title', () => {
                ...
                it('should fail validation when title is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('hosts', 'title', 'isString');
                });
            });
            ...
            describe('relationshipWithCelebratedPerson', () => {
                ...
                for (const relationshipWithCelebratedPerson of validRelationshipWithCelebratedPerson) {
                    it(`should pass validation when relationshipWithCelebratedPerson is ${relationshipWithCelebratedPerson}`, async () => {
                        createInvitationDto.hosts[0].relationshipWithCelebratedPerson = relationshipWithCelebratedPerson;
                ...
                it('should fail validation when relationshipWithCelebratedPerson is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('hosts', 'relationshipWithCelebratedPerson');
                });

                it('should fail validation when relationshipWithCelebratedPerson is not a valid enum value', async () => {
                    // @ts-expect-error - we want to test the validation
                    createInvitationDto.hosts[0].relationshipWithCelebratedPerson = 'invalid';

                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('hosts', 'relationshipWithCelebratedPerson', 'isEnum');
                });
            });
            ...
            describe('phoneNumber', () => {
                ...
                it('should fail validation when phoneNumber is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('hosts', 'phoneNumber', 'isString');
                });
            });
            ...
            describe('email', () => {
                ...
                it('should fail validation when email is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('hosts', 'email', 'isString');
                });
            });
        });
        ...
        describe('celebratedPersons', () => {
            ...
            describe('name', () => {
                it('should fail validation when name is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'name');
                });
                ...
                it('should fail validation when name is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'name', 'isString');
                });
            });
            ...
            describe('title', () => {
                it('should fail validation when title is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'title');
                });
                ...
                it('should fail validation when title is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'title', 'isString');
                });
            });
            ...
            describe('relationshipWithHost', () => {
                ...
                for (const relationshipWithHost of validRelationshipWithHost) {
                    it(`should pass validation when relationshipWithHost is ${relationshipWithHost}`, async () => {
                        createInvitationDto.celebratedPersons[0].relationshipWithHost = relationshipWithHost;
                ...
                it('should fail validation when relationshipWithHost is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'relationshipWithHost');
                });

                it('should fail validation when relationshipWithHost is not a valid enum value', async () => {
                    // @ts-expect-error - we want to test the validation
                    createInvitationDto.celebratedPersons[0].relationshipWithHost = 'invalid';

                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'relationshipWithHost', 'isEnum');
                });
            });
            ...
            describe('celebrationDate', () => {
                it('should fail validation when celebrationDate is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'celebrationDate');
                });

                it('should fail validation when celebrationDate is not a valid date string', async () => {
                    createInvitationDto.celebratedPersons[0].celebrationDate = 'invalid-date';

                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'celebrationDate', 'isDateString');
                });
            });
            ...
            describe('type', () => {
                ...
                it('should fail validation when type is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'type');
                });
                ...
                it('should fail validation when type is not a valid enum value', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('celebratedPersons', 'type', 'isEnum');
                });
            });
        });
        ...
        describe('date', () => {
            ...
            describe('gregorianDate', () => {
                it('should fail validation when gregorianDate is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('date', 'gregorianDate', undefined, false);
                });
                ...
                it('should fail validation when gregorianDate is not a valid date string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('date', 'gregorianDate', 'isDateString', false);
                });
            });
            ...
            describe('hijriDate', () => {
                ...
                it('should fail validation when hijriDate is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('date', 'hijriDate', 'isString', false);
                });
            });
        });
        ...
        describe('location', () => {
            ...
            describe('address', () => {
                it('should fail validation when address is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('location', 'address', undefined, false);
                });
                ...
                it('should fail validation when address is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('location', 'address', 'isString', false);
                });
            });
            ...
            describe('wazeLink', () => {
                ...
                it('should fail validation when wazeLink is not a valid URL', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('location', 'wazeLink', 'isUrl', false);
                });
            });

            describe('googleMapsLink', () => {
                it('should pass validation when googleMapsLink is provided', async () => {
                    createInvitationDto.location.googleMapsLink = 'https://maps.google.com/?q=123+Wedding+Hall';
                ...
                it('should fail validation when googleMapsLink is not a valid URL', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('location', 'googleMapsLink', 'isUrl', false);
                });
            });
        });
        ...
        describe('itineraries', () => {
            ...
            describe('activities', () => {
                it('should fail validation when activities is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('itineraries', 'activities');
                });
                ...
                it('should fail validation when activities is not an array', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('itineraries', 'activities', 'isArray');
                });

                it('should fail validation when activities array contains non-string values', async () => {
                    // @ts-expect-error - we want to test the validation
                    createInvitationDto.itineraries[0].activities = ['valid', 123, 'also-valid'];

                    const errors = await validate(createInvitationDto);

                    expect(errors).toHaveNestedValidationError('itineraries', 'activities', 'isString');
                });
            });
            ...
            describe('startTime', () => {
                it('should fail validation when startTime is not provided', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('itineraries', 'startTime');
                });
                ...
                it('should fail validation when startTime is not a valid time string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('itineraries', 'startTime', 'matches');
                });
            });
            ...
            describe('endTime', () => {
                ...
                it('should fail validation when endTime is not a valid time string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('itineraries', 'endTime', 'matches');
                });
            });
        });
        ...
        describe('contactPersons', () => {
            ...
            describe('name', () => {
                ...
                it('should fail validation when name is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('contactPersons', 'name', 'isString');
                });
            });
            ...
            describe('title', () => {
                ...
                it('should fail validation when title is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('contactPersons', 'title', 'isString');
                });
            });
            ...
            describe('relationshipWithCelebratedPerson', () => {
                ...
                for (const relationshipWithCelebratedPerson of validRelationshipWithCelebratedPerson) {
                    it(`should pass validation when relationshipWithCelebratedPerson is ${relationshipWithCelebratedPerson}`, async () => {
                        createInvitationDto.contactPersons[0].relationshipWithCelebratedPerson = relationshipWithCelebratedPerson;
                ...
                it('should fail validation when relationshipWithCelebratedPerson is not provided', async () => {
                    // @ts-expect-error - we want to test the validation
                    delete createInvitationDto.contactPersons[0].relationshipWithCelebratedPerson;

                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('contactPersons', 'relationshipWithCelebratedPerson');
                });

                it('should fail validation when relationshipWithCelebratedPerson is not a valid enum value', async () => {
                    // @ts-expect-error - we want to test the validation
                    createInvitationDto.contactPersons[0].relationshipWithCelebratedPerson = 'invalid';

                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('contactPersons', 'relationshipWithCelebratedPerson', 'isEnum');
                });
            });
            ...
            describe('phoneNumber', () => {
                ...
                it('should fail validation when phoneNumber is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('contactPersons', 'phoneNumber', 'isString');
                });
            });
            ...
            describe('whatsappNumber', () => {
                ...
                it('should fail validation when whatsappNumber is not a string', async () => {
                    ...
                    const errors = await validate(createInvitationDto);
                    expect(errors).toHaveNestedValidationError('contactPersons', 'whatsappNumber', 'isString');
                });
            });
        });
