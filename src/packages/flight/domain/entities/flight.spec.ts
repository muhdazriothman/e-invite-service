...
describe('@flight/domain/entities/flight', () => {
  ...
  describe('#constructor', () => {
    it('should create a Flight instance with provided props', () => {
      ...
      expect(flight.priceAfterDiscountFormatted).toBe(
        flightProps.priceAfterDiscountFormatted,
      );
    });
  });
  ...
  describe('#applyDiscount', () => {
    ...
    it('should throw an error if discount rate is greater than 10%', () => {
      ...
      expect(() => flight.applyDiscount(0.11)).toThrow(
        'Discount rate cannot be greater than 10%',
      );
    });
  });
});
