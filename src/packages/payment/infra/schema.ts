...
import { PaymentStatus, PaymentMethod, PlanType } from '@payment/domain/entities/payment';
...
export const PaymentMongoSchema = SchemaFactory.createForClass(PaymentMongoDocument);
