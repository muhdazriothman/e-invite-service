...
import { PaymentProps } from '@payment/domain/entities/payment';
...
export class PaymentRepository {
    ...
    async findAll(): Promise<Payment[]> {
        const documents = await this.paymentModel.find({
            isDeleted: false,
        }).lean();
    ...
    async update(id: string, updates: Partial<Pick<PaymentProps, 'status' | 'usedAt'>>): Promise<Payment | null> {
        const updateData = {
            ...updates,
            updatedAt: new Date(),
        };
