...
import { PaymentMapper, PaymentDto, PaymentResponseDto, PaymentListResponseDto } from '@payment/interfaces/http/mapper';
...
export class PaymentController {
    ...
    async createPayment(@Body() createPaymentDto: CreatePaymentDto) {
        ...
        const payment = await this.createPaymentUseCase.execute(createPaymentDto, createdBy);
